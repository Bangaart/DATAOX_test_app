...
3. After this it starts to scrap. (it can takes a lot of time so i am finding way to limit the number of pages, now i suggest to comment the code that yields next pages).
